...
const ProjectItem = ({ ...item }) => {
    return (
        <>
            <div className="bg-white rounded-lg py-5 mm:px-6 lg:px-10 border border-lightBorder dark:bg-blue-300/5 dark:border-darkBorder group">
                ...
                <div className="grid grid-cols-12 items-center">
                    ...
                    <div className="project-left py-10 mm:pr-0 lg:pr-10 mm:col-span-12 lg:col-span-6">
                        ...
                        <button onClick={() => window.open(`${item.project_address}`)} className="flex items-center w-36 space-x-5 rounded-md group-hover:bg-blue-500 duration-500 py-2 px-3 mt-10 group">
                            ...
                            <HiOutlineArrowNarrowRight className="text-2xl text-blue-500 group-hover:translate-x-3 group-hover:text-white duration-500 transition-all dark:text-white" />
                        </button>
