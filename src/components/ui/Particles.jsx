  ...
  return (
    <>
      <div className="particles">
        ...
        <div className="particle relative -z-10 rotate-[24deg] before:absolute before:bottom-28 before:left-56 before:h-5 before:w-5 before:rounded-md before:bg-gray-200 dark:before:bg-darkBorder/50"></div>
        ...
        <div className="particle relative -z-10 rotate-[28deg] before:absolute before:right-64 before:top-44 before:h-6 before:w-6 before:rounded-md before:bg-gray-300 dark:before:bg-darkBorder/40"></div>
      </div>
    </>
  );
};
